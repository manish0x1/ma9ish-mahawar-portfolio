...
import { SiNextdotjs, SiJavascript, SiTailwindcss, SiMongodb, SiRedux, SiFirebase, SiVercel, SiVite } from "react-icons/si";
  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: "Responsive Design", icon: <LayoutIcon className="w-4 h-4 text-[#38B2AC]" /> },
